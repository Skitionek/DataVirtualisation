(function () {
	...
	*/
	...
	Layout.$inject = ['$mdSidenav', '$cookies', '$state', '$mdToast', '$mdDialog','$mdBottomSheet'];
	...
	*/
	...
	function Layout($mdSidenav, $mdBottomSheet, $cookies, $state, $mdToast, $mdDialog ) {
		...
		vm.showFilterBottom = function ($event) {
			...
			vm.alert = '';
			$mdBottomSheet.show({
				templateUrl: 'app/modules/layouts/filter/filter.html',
