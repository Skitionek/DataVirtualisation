...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/plots/plotsModule.js',
			'app/modules/plots/plotsCtrl.js',
			'app/modules/plots/plotsRoute.js',
			'app/modules/plots/plotsService.js',
			'app/modules/plots/plots-test.js'
		],
